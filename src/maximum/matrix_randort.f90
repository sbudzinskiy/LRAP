...
integer         :: n, r, method_lrproj, ierr, seed, i, lwork, p, q
type(prng)      :: rng
real(WP)        :: foo(1)
...
! Generate data ----------------------------------------------------------
call drandort(rng, n, n, A, n, foo, -1, ierr)
lwork = int(foo(1))
allocate( work(lwork) )
call drandort(rng, n, n, A, n, work, lwork, ierr)
deallocate( work )
